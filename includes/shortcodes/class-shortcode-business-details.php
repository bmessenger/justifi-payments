<?php
/**
 * Add the Shortcode for the Business Details Web Component in Justifi
 *
...
class Business_Details {
	...
	public function generate_shortcode() {
		add_shortcode( 'Justifi_Business_Details', array( $this, 'form_generate' ) );
	}
	...
	public function form_generate () {
			...
			if ( isset( $biz['biz_id'] ) ) {
		 		...
		 		$output = '<justifi-business-details business-id="' .$biz['biz_id']. '" auth-token="' .$biz['web_token']. '"></justifi-business-details>';	
				return $output;
...
new \Justifi_Payments\Shortcodes\Business_Details();